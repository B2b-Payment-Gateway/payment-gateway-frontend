				...
				>
					<ul className="space-y-1.5">
						...
						<li className="hs-accordion">
							<a
								className={`hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 text-sm ${
									currentScreen === "wallets"
										? `border border-blue-500 text-blue-500`
										: `text-slate-700`
								}  rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 `}
								href="#"
							...
							<div className="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden"></div>
						</li>
