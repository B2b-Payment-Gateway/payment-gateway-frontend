	...
	const submitHandler = async (e) => {
		...
		try {
			...
			const { data } = await axios.post(
				"/api/v1/biz/register",
				{ email, password, organization, category },
				config
			);
							...
							<form>
								<div className="grid gap-y-4">
									...
									<div>
										...
										>
											Please include a valid organization
									...
									<div>
										...
										<div className="relative">
											<input
												...
												className="py-3 px-4 block w-full border focus:outline-none border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400"
												required
